...
def ipfabric_build_vars(build_vars):
    ...
    print("spine_downlink_count :", spine_downlink_count)
    spine_ports_per_leaf = leaf_uplink_count / spine_count
    print("spine_ports_per_leaf :", spine_ports_per_leaf)
...
class FilterModule(object):
    ...
    def filters(self):
        return {
            'ipfabric_wbxPort_to_portIndex': ipfabric_wbxPort_to_portIndex, 
            'ipfabric_ethosPort_to_portIndex': ipfabric_ethosPort_to_portIndex, 
            'ipfabric_portIndex_to_wbxPort': ipfabric_portIndex_to_wbxPort,
            'ipfabric_portIndex_to_ethosPort': ipfabric_portIndex_to_ethosPort,
            'ipfabric_generate_port_range': ipfabric_generate_port_range,
            'ipfabric_portindexlist_to_SROS_list': ipfabric_portindexlist_to_SROS_list,
            'ipfabric_portindexlist_to_ETHOS_list': ipfabric_portindexlist_to_ETHOS_list,
            'integer_to_anycast_mac': integer_to_anycast_mac,
            'ipfabric_build_vars': ipfabric_build_vars
        }
